 ...
 *
 */
public class MoveCameraStrafeLeftCommand extends CommandBase {
    @SuppressWarnings({ "PMD.UnusedPrivateField", "PMD.SingularField" })
    private final DrivebaseSubsystem m_drivebaseSubsystem;
    private final VisionProcessor m_VisionProcessor;

    public MoveCameraStrafeLeftCommand(DrivebaseSubsystem drivebaseSubsystem, VisionProcessor visionProcessor) {
    ...
    @Override
    public void execute() {
        m_drivebaseSubsystem.strafeLeft();
    }
